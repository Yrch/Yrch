...
class CategoryController extends Controller
{
    public function menuAction($id_category = null)
    {
        ...
        return $this->render('YrchBundle:Category:menu.html.twig', array ('categories' => $categories));
    }
    ...
    public function showAction($id = null)
    {
        ...
        return $this->render('YrchBundle:Category:show.html.twig', compact('category', 'title', 'sites', 'path', 'id_root'));
    }
}
